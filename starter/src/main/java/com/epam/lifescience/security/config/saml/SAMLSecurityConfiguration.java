...
import com.epam.lifescience.security.saml.OptionalSAMLLogoutFilter;
import com.epam.lifescience.security.saml.SAMLContextProviderCustomSingKey;
...
import static com.epam.lifescience.security.utils.ConfigUtils.SLASH;
import static com.epam.lifescience.security.utils.ConfigUtils.getRequestMatcher;
import static com.epam.lifescience.security.utils.ConfigUtils.getUrlWithoutTrailingSlash;
import static com.epam.lifescience.security.utils.ConfigUtils.isNotBlankStringArray;

@Configuration
@ComponentScan(basePackages = "com.epam.lifescience.security.saml")
@Order(2)
public class SAMLSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    @Value("${security.config.success.logout.url:/}")
    ...
    @Value("${security.config.saml.secured.urls:/**}")
    ...
    private SAMLSecurityConfigurationExtender configurationExtender;
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        http.requestMatcher(getRequestMatcher(ConfigUtils.ANY_URL_PATTERN))
            .httpBasic()
    ...
    private String[] getPublicResources() {
        ...
        resources.add(loginFailureRedirect);
    ...
    public KeyManager keyManager() {
        final DefaultResourceLoader loader = new FileSystemResourceLoader();
        ...
        final String defaultKey = keyAlias;
    ...
    public ExtendedMetadataDelegate extendedMetadataDelegate() {
        try {
            final FilesystemMetadataProvider metadataProvider =
    ...
    public SAMLContextProviderImpl contextProvider() {
        return new SAMLContextProviderCustomSingKey(signingKey, validateMessageInResponse);
    }
    ...
    public WebSSOProfileConsumer webSSOprofileConsumer() {
        final WebSSOProfileConsumerImpl profileConsumer = new WebSSOProfileConsumerImpl();
        profileConsumer.setMaxAuthenticationAge(maxAuthenticationAge);
    ...
    public SingleLogoutProfile logoutprofile() {
        final SingleLogoutProfileImpl logoutProfile = new SingleLogoutProfileImpl();
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityBaseURL(getUrlWithoutTrailingSlash(endpointId));
    ...
    public SavedRequestAwareAuthenticationSuccessHandler successRedirectHandler() {
        ...
        successRedirectHandler.setDefaultTargetUrl(SLASH);
    ...
    public SimpleUrlLogoutSuccessHandler successLogoutHandler() {
        ...
        successLogoutHandler.setDefaultTargetUrl(SLASH);
